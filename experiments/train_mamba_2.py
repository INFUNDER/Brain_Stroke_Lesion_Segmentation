...
from monai.transforms import (
    ...
    Orientationd, NormalizeIntensityd, RandCropByPosNegLabeld,
    RandFlipd, RandRotate90d, EnsureTyped, SpatialPadd,
    CropForegroundd, ScaleIntensityRangePercentilesd # Naye imports
)
# =========================
# CONFIG & PATHS
# =========================
...
# =========================
# UPGRADED TRANSFORMS (For Higher Dice Score)
# =========================
train_transforms = Compose([
    ...
    # 1. CROP FOREGROUND: Background hatao, sirf brain pe focus karo
    CropForegroundd(keys=["image", "label"], source_key="image"),
    
    Spacingd(keys=["image", "label"], pixdim=(1.5, 1.5, 2.0), mode=("bilinear", "nearest")),
    Orientationd(keys=["image", "label"], axcodes="RAS"),
    
    # 2. PERCENTILE CLIPPING: Scanner ka noise/extreme bright spots hatao
...
val_transforms = Compose([
    ...
    # Validation mein bhi Crop karna zaroori hai
    CropForegroundd(keys=["image", "label"], source_key="image"),
