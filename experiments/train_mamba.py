...
class MambaLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        return x_mamba.transpose(1, 2).view(b, c, h, w, d) + x
...
class MambaUNet(nn.Module):
    def __init__(self, in_channels=3, out_channels=2, features=(16, 32, 64, 128, 256)):
        ...
        self.mamba_block = MambaLayer(dim=features[4])
...
# 1. imag enchancment tech like clahe , canny edge detection etc
# 2. tuweking architecture of mamba to introduce the novelty and makw it quality better than unetr (by using gpt's analy our result)=
# 3. by utilizeing esemble teq or model like mixture of experts model , expert gated mechanism 
# 4. exploration of knowledge distillation technique.
#  