...
scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=MAX_EPOCHS) # Added Scheduler
...
for epoch in range(MAX_EPOCHS):
    ...
    print(f"Epoch [{epoch+1}/{MAX_EPOCHS}] Loss: {epoch_loss:.4f} | LR: {scheduler.get_last_lr()[0]:.6f}", flush=True)
